...
<head>
    ...
    <title>All Pass 行李箱專賣 | Your All-Access Pass</title>
    <style>
        /* 全局設定 */
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'PingFang TC', 'Microsoft JhengHei', sans-serif; }
        ...
        .header-left { flex: 1; } 
        .header-center { flex: 1; text-align: center; font-size: 32px; font-weight: 800; color: #ffffff; letter-spacing: 4px; }
...
<body>
    ...
    <header>
        <div class="header-top">
            ...
            <div class="header-center">All Pass</div>
        ...
        <div class="header-bottom">
            <nav class="nav-links">
                <a href="#" class="nav-text-link">NEW IN 新品</a>
